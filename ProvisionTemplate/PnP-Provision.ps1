...
try
{
	...
	Apply-SPOProvisioningTemplate -Path .\templates\Provision.Infrastructure.xml -Handlers Files
	Write-Host ""
	Write-Host -ForegroundColor Green "Infrastructure Provisioned"

	Apply-SPOProvisioningTemplate -Path .\templates\Provision.Data.xml -Handlers Lists
	Write-Host ""
	Write-Host -ForegroundColor Green "Data Provisioned"

	Apply-SPOProvisioningTemplate -Path .\templates\Provision.Data.xml -Handlers Files
	Write-Host ""
	...
	Apply-SPOProvisioningTemplate -Path .\templates\Provision.CustomActions.xml -Handlers CustomActions,Features -Parameters @{"InfrastructureSiteUrl"=$rootPath}
